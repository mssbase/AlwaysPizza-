...
class Booking{
  ...
  render(element){
    ...
    thisBooking.dom.tablesAll    = thisBooking.dom.wrapper.querySelectorAll(select.booking.tablesAll);
    console.log('thisBooking.dom.tablesAll', thisBooking.dom.tablesAll)
